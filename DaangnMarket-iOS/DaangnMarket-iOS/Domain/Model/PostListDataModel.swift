...
extension PostListDataModel{
    static let sampleData: [PostListDataModel] = [
        ...
        PostListDataModel(productImageName: "productImageName03", productName: "선풍기", placeName: "", price: "32,000원"),
        PostListDataModel(productImageName: "productImageName04", productName: "데스크탑", placeName: "", price: "32,000원"),
        PostListDataModel(productImageName: "productImageName05", productName: "귀걸이", placeName: "", price: "32,000원"),
        PostListDataModel(productImageName: "productImageName06", productName: "노트북", placeName: "", price: "32,000원"),    ]
}
